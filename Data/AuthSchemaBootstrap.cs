...
public static class AuthSchemaBootstrap
{
    ...
    {
        var sql = @"
IF OBJECT_ID('dbo.Users','U') IS NULL CREATE TABLE dbo.Users (Id int IDENTITY(1,1) NOT NULL PRIMARY KEY, FullName nvarchar(150) NOT NULL, Email nvarchar(256) NOT NULL, PasswordHash nvarchar(max) NOT NULL, IsActive bit NOT NULL DEFAULT 1, CreatedAtUtc datetime2 NOT NULL DEFAULT SYSUTCDATETIME());
