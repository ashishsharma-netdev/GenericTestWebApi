...
builder.Services.AddScoped<SubscriptionLifecycleService>(); builder.Services.AddScoped<AdminAuditService>(); builder.Services.AddHostedService<SubscriptionLifecycleHostedService>();
